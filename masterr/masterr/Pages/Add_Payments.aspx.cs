...
namespace masterr.Pages
{
    public partial class Add_Payments : System.Web.UI.Page
    {
        ...
        protected void Submit__Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("insert into Payment " + "(Ammount,Users_P,type_P) VALUES (@Ammount,@Users_P,'Pay')", con);
                cmd.Parameters.AddWithValue("@Ammount", payments.Text);
                cmd.Parameters.AddWithValue("@Users_P", Members_List.SelectedValue);
                cmd.ExecuteNonQuery();
                con.Close();
