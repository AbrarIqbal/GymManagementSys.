...
{
    public partial class Specific_Exercise_Plan : System.Web.UI.Page
    {
        ...
        protected void Submit__Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("insert into Exercise_Plan" + "(Title,Description,Member) VALUES (@Title,@Description,@Member)", con);
                cmd.Parameters.AddWithValue("@Title", title.Text);
                cmd.Parameters.AddWithValue("@Description", E_Description.Text);
                cmd.Parameters.AddWithValue("@Member", Member.SelectedValue);
                cmd.ExecuteNonQuery();
                con.Close();
