<%@ Page Title="View Payments" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="View_Payments.aspx.cs" Inherits="masterr.Pages.View_Payments" %>
...
<div class="container">
<div class="jumbotron">
<h3 class="h1 texy-center" style="text-align:center;"> Payment Details</h3>
...
<div id="admins">
    ...
    <asp:SqlDataSource ID="Admin_V" runat="server" ConnectionString="<%$ ConnectionStrings:GYMConnectionString %>" DeleteCommand="DELETE FROM [Payment] WHERE [Payment_id] = @Payment_id" InsertCommand="INSERT INTO [Payment] ([Ammount], [Users_P]) VALUES (@Ammount, @Users_P)" SelectCommand="SELECT [Payment_id], [Ammount], [Users_P] FROM [Payment]" UpdateCommand="UPDATE [Payment] SET [Ammount] = @Ammount, [Users_P] = @Users_P WHERE [Payment_id] = @Payment_id">
        <DeleteParameters>
    ...
    <div id="membersv">
        <asp:gridview CssClass="table table-striped table-bordered table-condensed" runat="server" ID="Member_V"></asp:gridview>
    <p id="butn" runat="server" class="active">  <a name='linkPay' href='https://secure.payza.com/checkout?CDdDa21ndnRvZXZnLDdDf3pvenRne3dldmcsQ0NtZ3w4U0dHfGhaWW17fEpZc0t0e01TQ2pveml7anV4dmV2ZwI='>Pay Online</a></p>
    </div>
