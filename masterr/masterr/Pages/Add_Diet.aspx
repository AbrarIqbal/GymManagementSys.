<%@ Page Title="Add Diet" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="Add_Diet.aspx.cs" Inherits="masterr.Pages.Add_Diet" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        ...
        
  {
    ...
    /*background:radial-gradient(rgb(153,217,220) 30%, rgb(83,203,255) 70%);
        display: block;
        max-width: 100%;
        height: auto;
...
<div class="form-group">
  ...
  <div class="col-md-4">
      <asp:TextBox CssClass="form-control input-md" placeholder="Enter Description" ID="target_muscle" runat="server"></asp:TextBox> 
  </div>
</div>
