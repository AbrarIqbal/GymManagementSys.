...
namespace masterr.Pages
{
    public partial class Add_parent : System.Web.UI.Page
    {
        ...
        protected void Submit__Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("insert into Users " + "(user_name,user_password,Name,age,Height,Weight,condition,Mail,Address,DOB,Contact,role_id) VALUES (@user_name,@user_password,@Name,@age,@Height,@Weight,@condition,@Mail,@Address,@DOB,@Contact,3)", con);
                ...
                cmd.Parameters.AddWithValue("@condition", MC.Text);
