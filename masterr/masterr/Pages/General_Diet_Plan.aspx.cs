...
{
    public partial class General_Diet_Plan : System.Web.UI.Page
    {
        ...
        protected void Submit__Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("insert into Diet_Plan " + "(Title,Description,Member) VALUES (@Title,@Description,'General')", con);
