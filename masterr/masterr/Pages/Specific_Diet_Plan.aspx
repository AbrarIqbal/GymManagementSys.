<%@ Page Title="Specific Diet Plan" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="Specific_Diet_Plan.aspx.cs" Inherits="masterr.Pages.Specific_Diet_Plan" %>
...
<!-- Form Name -->
<legend>Specific Diet Plan Form</legend>
...
<div class="form-group">
  ...
  <div class="col-md-4">
      <asp:dropdownlist runat="server" ID="Name" DataSourceID="Members" DataTextField="Name" DataValueField="Name"></asp:dropdownlist> 
